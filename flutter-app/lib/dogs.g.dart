...
import 'package:tremors/models/mapping.conv.g.dart';
import 'package:dogs_core/dogs_core.dart';
import 'package:tremors/models/mapping.conv.g.dart' as gen0;
export 'package:tremors/models/mapping.conv.g.dart';
...
Future initialiseDogs() async {
  ...
  engine.registerAllConverters([
    gen0.CameraConverter(),
    gen0.MapStateConverter(),
    gen0.TileLayerDescriptorConverter(),
    gen0.MapTypeConverter(),
    gen0.MapInfoConverter()
  ]);
  engine.setSingleton();
}
